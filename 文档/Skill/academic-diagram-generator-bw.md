...
第一，防止 Codex 乱画彩色营销图。它明确限制黑白灰、线宽、字体、箭头语义和输出格式。

第二，防止图看起来“AI味”。它要求工程框图、网格对齐、短标签、无装饰、无渐变。

第三，防止比赛报告被质疑造数据。它强制区分“实测数据”和“示意数据”。

第四，贴合你的 ADAS 项目。里面已经内置了 Loongson、ADAS Main SoC、Backup SoC、Safety MCU、ACC/AEB/LKA、SEQ、UART 仲裁、MIL/HIL 等图形语义。